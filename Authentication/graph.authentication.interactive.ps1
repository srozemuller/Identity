...
Write-Information "The client_id in the body is: $ClientId" -InformationAction Continue
Write-Information "The tenant in the body is: $TenantName" -InformationAction Continue
...
Write-Information "`n$($graphCodeRequest.message)" -InformationAction Continue
